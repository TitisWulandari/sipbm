...
--
-- Host: localhost:3306
-- Generation Time: Dec 12, 2020 at 11:36 AM
...
--
-- Table structure for table `tbl_about_museum`
--
...
--
-- Dumping data for table `tbl_about_museum`
--
...
(1, 'Museum Soesilo Soedarman', 'Museum Soesilo Soedarman adalah bangunan bersejarah berbentuk museum yang menyimpan peninggalan-peninggalan Jendral TNI (Purn) Soesilo Soedarman semasa mengabdikan diri. Museum ini terletak di Desa Gentasari, Kec. Kroya, Kab. Cilacap, Jawa Tengah.', 'Wisata-Sejarah-Jalan-Jalan-Seru-ke-Museum-Soesilo-Soedarman.jpg', '2020-11-02 21:59:00', NULL, 1);
...
--
-- Table structure for table `tbl_observasi`
--
...
--
-- Dumping data for table `tbl_observasi`
--
...
(15, 'kucel sekali', '11', '2020-12-12 14:27:00', 'membersihkan', 'lap', 'belum ada', NULL, 'waiting', '2020-12-12 07:28:01', '2020-12-12 07:28:01', 16, NULL, 10, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `tbl_permintaan_perbaikan`
--
...
--
-- Dumping data for table `tbl_permintaan_perbaikan`
--
...
--
-- Table structure for table `tbl_ruang_koleksi`
--
...
--
-- Dumping data for table `tbl_ruang_koleksi`
--
...
(1, 'Titis Wulandari', 'wulan@gmail.com', '$2y$10$n44kS7TVTWKZM56CTkrr5u4qBlo1iDcT90.WW0rNA4vQyTFsikhDa', 'admin', '2020-12-12 18:26:05', '2020-12-12 18:26:43', 'Jakarta barat', 'fokokuuuuu1.jpg', '2020-10-30 21:38:07', '2020-11-02 06:57:53', NULL, NULL, NULL, NULL, '07342839'),
(2, 'Asep Sukmana Hafid', 'asep.pusat@gmail.com', '$2y$10$q5/Li5eutxYyBjrENQRyzewggufk5/RcqjNS2gvkap2KKp7a9f6S.', 'pihak_pusat', '2020-12-12 13:44:38', '2020-12-12 13:46:56', 'tes', 'admin1.png', '2020-10-31 07:52:37', '2020-11-02 13:37:18', NULL, NULL, NULL, NULL, '08522339794'),
(3, 'Darjito', 'jamil.pengelola@gmail.com', '$2y$10$C8JcwF8kJqy9xo98gp5iKet025uvdlbD5stbtMqFD/SsAOpmykuT.', 'pengelola', '2020-12-12 18:26:56', '2020-12-12 18:29:03', 'Jl. Mancasan Kidul Depok Sleman Yogyakarta', 'mbah_jito1.jpg', '2020-10-31 07:57:27', '2020-11-02 13:37:30', NULL, NULL, NULL, NULL, '085927767988'),
...
(16, 'Billy Elang Herlambang', 'petugas.elang@gmail.com', '$2y$10$nCd6bz7wI/MDk.MvJ/2KHeza2eNtZdDL5Q84R2ieG4Uugbj3ac1ly', 'petugas_perawatan', '2020-12-12 18:29:45', '2020-12-12 18:33:42', 'Jalan Raya Maos', 'IMG-20190927-WA00071.jpg', '2020-11-03 08:11:39', '2020-11-03 19:55:52', NULL, NULL, NULL, NULL, '08976537829');
...
--
-- Indexes for table `tbl_about_museum`
--
...
--
-- Indexes for table `tbl_observasi`
--
...
--
-- Indexes for table `tbl_permintaan_perbaikan`
--
ALTER TABLE `tbl_permintaan_perbaikan`
  ADD PRIMARY KEY (`id_permintaan_perbaikan`);

--
-- Indexes for table `tbl_ruang_koleksi`
--
...
--
-- AUTO_INCREMENT for table `tbl_about_museum`
--
ALTER TABLE `tbl_about_museum`
...
--
ALTER TABLE `tbl_jenis_koleksi`
  MODIFY `id_jenis_koleksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `tbl_observasi`
--
ALTER TABLE `tbl_observasi`
...
--
ALTER TABLE `tbl_perawatan`
  MODIFY `id_perawatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tbl_permintaan_perbaikan`
--
ALTER TABLE `tbl_permintaan_perbaikan`
  MODIFY `id_permintaan_perbaikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_ruang_koleksi`
--
ALTER TABLE `tbl_ruang_koleksi`
