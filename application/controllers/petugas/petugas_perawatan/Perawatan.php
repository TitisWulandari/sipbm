...
class Perawatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('petugas/perawatan/index');
    ...
    {
        $client = $this->Perawatan_model->getPById($id);
        $status_client = "";

        if ($client->validasi_perawatan == "belum") {
        ...
        $data = array(
            'id_perawatan'         => $id,
            'validasi_perawatan'     => $status_client
        );

        $this->Perawatan_model->updateData($id, $data);

        redirect(site_url('petugas/petugas_perawatan/perawatan'));
    }
